...
import 'package:to_do_project/features/main_screen/Index/create_cotegory_screen.dart';
...
class ChooseCategoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final categories = [
      ...
      CategoryModel(name: 'Work', icon: Icons.work, color: Colors.deepOrange),
      CategoryModel(
        name: 'Sport',
      ...
      CategoryModel(name: 'Home', icon: Icons.home, color: Colors.orangeAccent),
    ];
