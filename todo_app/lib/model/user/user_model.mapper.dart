...
class UserModelMapper extends ClassMapperBase<UserModel> {
  ...
  static String _$confirmPass(UserModel v) => v.confirmPass;
  static const Field<UserModel, String> _f$confirmPass =
      Field('confirmPass', _$confirmPass);

  @override
  final MappableFields<UserModel> fields = const {
    #userName: _f$userName,
    #passWord: _f$passWord,
    #confirmPass: _f$confirmPass,
  };
  ...
  static UserModel _instantiate(DecodingData data) {
    return UserModel(
        ...
        confirmPass: data.dec(_f$confirmPass));
  }
...
abstract class UserModelCopyWith<$R, $In extends UserModel, $Out>
  ...
  $R call({String? userName, String? passWord, String? confirmPass});
...
class _UserModelCopyWithImpl<$R, $Out>
  ...
  $R call({String? userName, String? passWord, String? confirmPass}) =>
      $apply(FieldCopyWithData({
        ...
        if (confirmPass != null) #confirmPass: confirmPass
      }));
  @override
  UserModel $make(CopyWithData data) => UserModel(
      userName: data.get(#userName, or: $value.userName),
      passWord: data.get(#passWord, or: $value.passWord),
      confirmPass: data.get(#confirmPass, or: $value.confirmPass));
